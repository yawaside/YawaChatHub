...
* Иконки: `desktop/build/icon.ico` (многослойный: 16/24/32/48/64/128/256 — именно
  ...
  (256×256, фолбэк для трея). Оба файла лежат в репозитории; перед сборкой их
  освежает `scripts/prepare-icon.ps1` (PWShell, System.Drawing): берёт
  `desktop/electron/assets/yawachat-icon-master.png`, а при его отсутствии рисует
  бренд-иконку программно. Запускать вручную не обязательно — CI делает сам.
