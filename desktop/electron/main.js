...
// Локальный аудиорендер для Edge TTS: main process синтезирует MP3/WAV,
// renderer проигрывает через <audio>. Это надёжнее, чем headless MediaPlayer/WPF.
ipcMain.handle("tts:synthesize", (_e, payload) => tts.synthesizeWavBase64(payload));
