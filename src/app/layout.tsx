  ...
  return (
    <html lang="ru">
      <head>
        ...
        {/* Шрифты вне критического пути: первый экран рисуется системным
            шрифтом сразу, веб-шрифты подменяют его по готовности, а без
            сети запуск не ждёт сетевой таймаут. */}
        <FontLoader />
      </head>
      <body>
        <div id="boot">
