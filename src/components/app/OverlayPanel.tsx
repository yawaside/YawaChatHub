      ...
      <div className="min-w-0 space-y-4">
        ...
        <Panel title="Текст" collapsible>
          <div className="space-y-3">
            ...
            />
            <div>
              <Label hint={cfg.textOutline === 0 ? "выкл" : `${cfg.textOutline} px`}>Обводка текста</Label>
              <Slider
        ...
        <Panel title="Содержимое" collapsible>
          <div className="space-y-3">
            ...
            <div>
              <Label hint={cfg.ttl === 0 ? "не скрывать" : `${cfg.ttl} с`}>Время показа сообщения</Label>
              <Slider
                value={cfg.ttl}
                min={0}
                max={60}
            ...
            <div>
              <Label hint={cfg.rowGap === 0 ? "вплотную" : `${cfg.rowGap} px`}>Интервал между сообщениями</Label>
              <Slider
                value={cfg.rowGap}
                min={0}
                max={16}
