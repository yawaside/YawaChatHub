...
import {
  Activity, AudioWaveform, Ban, ExternalLink, Gamepad2, HeartHandshake, Info, Keyboard, LayoutList, Menu, Minus,
  Monitor, Palette, Settings, SlidersHorizontal, Square, Video, Volume2, X,
} from "lucide-react"
...
export default function DesktopApp() {
  ...
  useEffect(() => {
    ...
    getSp()?.widgetConfig?.({ tts: ttsSafe });
    ...
    >
      ...
      >
        <div className="flex min-w-0 items-center gap-2.5">
          ...
          <span className="truncate text-[14px] font-semibold leading-none tracking-tight">
            <span style={{ color: "var(--dw-text)" }}>Yawa</span>
            <span
              className="mx-1 inline-block rounded-md px-1.5 py-0.5 align-middle text-[11.5px] leading-none"
              style={{
                color: "#fff",
                background: "linear-gradient(135deg,#8b5cf6 0%,#22d3ee 100%)",
                boxShadow: "0 0 10px rgba(139,92,246,0.5), inset 0 0 0 1px rgba(255,255,255,0.2)",
