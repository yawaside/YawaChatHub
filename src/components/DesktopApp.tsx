...
import {
  DEFAULT_CHAT_VIEW, DEFAULT_HOTKEYS, DEFAULT_OVERLAY, DEFAULT_WIDGET, buildChibiWidgetUrl, buildWidgetUrl,
} from "../lib/widget";
...
export default function DesktopApp() {
  ...
  const chibiWidgetUrl = useMemo(
    () => (desktop ? widgetInfo.chibiUrl || buildChibiWidgetUrl(widgetInfo.port, widgetInfo.token) : ""),
    [desktop, widgetInfo.chibiUrl, widgetInfo.port, widgetInfo.token]
  );
