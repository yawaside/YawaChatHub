...
public sealed class TikTokConnector : IPlatformConnector
{
    ...
    /// <summary>
    /// Релиз — это один exe, рядом с ним каталога моста нет. Поэтому bridge.js
    /// и package.json встроены в сборку: разворачиваем их в
    /// %LOCALAPPDATA%\YawaChatHub\tiktok-bridge и один раз ставим
    /// tiktok-live-connector (npm идёт в комплекте с Node.js).
    /// </summary>
    ...
    public Task RunAsync(CancellationToken ct)
    {
        ...
        if (dir == null)
        {
            ...
            throw new InvalidOperationException(
                "TikTok: нужен установленный Node.js — мост tiktok-live-connector не развернулся");
        }
